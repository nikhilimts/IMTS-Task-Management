...
import { ArrowLeft, Users, CheckSquare, Clock, TrendingUp, User, Calendar } from 'lucide-react';
    ...
    const fetchDepartmentDetail = async () => {
      ...
      try {
        ...
        const transformedData: DepartmentDetailData = {
          ...
          hod: backendData.department.hodUser || null,
        ...
        // Fetch employees and tasks separately
        const [employeesResponse, tasksResponse] = await Promise.all([
          adminService.getDepartmentEmployees(departmentId),
          adminService.getDepartmentTasks(departmentId)
        ]);
        
        // Update with employees and tasks
        setDepartment(prev => prev ? {
          ...prev,
          employees: employeesResponse.data.data.employees.map((emp: any) => ({
            _id: emp._id,
            name: emp.name,
            email: emp.email,
            role: emp.role,
          ...
          tasks: tasksResponse.data.data.tasks.map((task: any) => ({
            _id: task._id,
            title: task.title,
